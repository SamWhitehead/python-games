#!/usr/bin/env python
# A first go with devtable used to see what it's like for writing python code etc
# Sam Whitehead 5 July 2013
...
def main():
    ...
    while True:
        ...
        # Dealing with ending of sequence
        screen.fill(BLACK)
